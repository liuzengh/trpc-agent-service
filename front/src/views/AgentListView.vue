    ...
    <el-dialog v-model="publishVisible" :title="`发布 ${publishing}`" width="560px">
      <el-form label-width="100px">
        ...
        <el-form-item label="模型端点">
          <el-select v-model="pubForm.endpoint_id" placeholder="选择端点" style="width: 100%">
            <el-option v-for="e in endpoints.endpoints" :key="e.id" :label="`${e.name} (${e.model_name})`" :value="e.id" />
          </el-select>
        </el-form-item>
