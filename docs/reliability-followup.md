...
日期：2026-09-07。代码候选 `0.2.0-rc.4`，schema 23。本文记录代码开发结束时的范围，当时日常实例尚未升级；后续已在用户授权下升级本地实例并开启 Telegram 附件，详见[部署与待验证记录](validation/local-rc4-upgrade-2026-09-07.md)。下文“未部署/未配置”均指开发阶段的状态，不代表后续部署结果。
