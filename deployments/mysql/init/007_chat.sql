...
CREATE TABLE IF NOT EXISTS chat_session_summaries (
    session_id VARCHAR(128) NOT NULL,
    seq        BIGINT       NOT NULL                COMMENT 'event watermark this summary covers',
    summary    MEDIUMTEXT   NOT NULL,
    updated_at DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (session_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
  COMMENT='business-level session summary (complements the framework session_summaries)';
...
CREATE TABLE IF NOT EXISTS memories (
  ...
  COMMENT='long-term memory metadata; runtime memory lives in memory/redis';
