...
CREATE TABLE IF NOT EXISTS artifacts (
    ...
    object_uri  VARCHAR(512) NOT NULL              COMMENT 'MinIO path {tenant_id}/..., short-lived signed URL only',
    preview     JSON         NULL                  COMMENT 'preview info (thumbnail/summary)',
    created_at  DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (artifact_id),
    KEY idx_artifact_tenant_agent (tenant_id, agent_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
  COMMENT='artifact metadata; bytes in MinIO';
