...
func TestIsolatedPostgresContracts(t *testing.T) {
	...
	cmd := exec.CommandContext(ctx, "go", "test", "-race", "-count=1",
		...
		"./trpcservice/toolexec", "./trpcservice/background", "./trpcservice/controlplane", "./trpcservice/storage", "./trpcservice/audit", "./trpcservice/gateway", "./trpcservice/attachments", "./trpcservice/agent")
	cmd.Dir = root
