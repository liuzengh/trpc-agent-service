...
func documentNames() []string {
	return []string{"architecture.md", "backend-adapters.md", "data-consistency.md", "data-model.md", "feature-status.md", "im-channels.md", "operations-runbook.md", "project-docs-mcp.md", "security-boundaries.md", "sequence.md"}
}
