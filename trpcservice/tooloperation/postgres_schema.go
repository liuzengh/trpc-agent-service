...
// PostgreSQLSchemaDDL is the migration body required by Postgres. It is
// exported for a versioned, independently privileged migrator; application
// startup must not execute it with the runtime data-plane role.
//
// The schema intentionally has no raw argument, response-body, error-message,
// or lease-owner columns. Every sensitive value is represented by a SHA-256 or
// by a caller-supplied, grammar-restricted redacted code/reference.
